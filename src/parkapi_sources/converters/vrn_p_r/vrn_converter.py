...
from .vrn_models import VrnParkAndRideFeaturesInput


class VrnParkAndRidePullConverter(PullConverter):
    ...
    source_info = SourceInfo(
        ...
        source_url='https://spatial.vrn.de/data/rest/services/Hosted/p_r_parkapi_static/FeatureServer/5/query?where=objectid%3E0&outFields=*&returnGeometry=true&f=geojson',
    ...
    def _get_raw_static_parking_sites(self) -> tuple[list[StaticParkingSiteInput], list[ImportParkingSiteException]]:
