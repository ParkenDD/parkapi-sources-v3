...
class KienzlerPullConverter(PullConverter):
    ...
    def get_static_parking_sites(
        ...
        kienzler_parking_sites, static_parking_site_errors = (
            self._get_kienzler_parking_sites()
        )
        for kienzler_parking_site in kienzler_parking_sites:
            static_parking_site_inputs.append(
                kienzler_parking_site.to_static_parking_site()
            )
    ...
    def get_realtime_parking_sites(
        ...
        for kienzler_parking_site in kienzler_parking_sites:
            realtime_parking_site_inputs.append(
                kienzler_parking_site.to_realtime_parking_site()
            )
    ...
    def _get_kienzler_parking_sites(
        ...
        for parking_site_dict in parking_site_dicts:
            try:
                kienzler_item_inputs.append(
                    self.kienzler_item_validator.validate(parking_site_dict)
                )
