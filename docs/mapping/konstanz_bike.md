...
- Only parking entries with [Zustand](#Zustand): 1 from data source are integrated
...
| Key  | Mapping | Comment               |
| ---- | ------- | --------------------- |
| 1    | true    | Überdachung vorhanden |
| 0    | false   | keine Überdachung     |

## Beleuchtung

| Key  | Mapping | Comment               |
| ---- | ------- | --------------------- |
| 1    | true    | Beleuchtung vorhanden |
| 0    | false   | keine Beleuchtung     |

## Zustand

| Key  | Comment             |
| ---- | ------------------- |
| 0    | keine Abstellanlage |
| 1    | bestehend           |
| 2    | geplant             |
