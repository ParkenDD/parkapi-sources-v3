...
Parking installations with `"Betreiber":"privat"` should not be integrated.
...
| coordinates[1]             | numeric                             | 1           | lat                                      | GeoJSON geometry coordinates index 1 and rounded up to 7 decimal places  (e.g. 48.552221802366965 should be 48.5522218)  |
| coordinates[0]             | numeric                             | 1           | lon                                      | GeoJSON geometry coordinates index 0 and rounded up to 7 decimal places  (e.g. 8.7234782203195511 should be 8.7234782)   |
