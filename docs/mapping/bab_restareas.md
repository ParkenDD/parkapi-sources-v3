...
| parkingAlias.                                | string    | ?
| parkingDescription                           | string    | 1           |                                           | mostly administrative information
...
| groupOfParkingSpaces[lorry]                  | integer   | 1           | restriction[TRUCK].capacity               | set only if != 0
| groupOfParkingSpaces[car]                    | integer   | 1
| groupOfParkingSpaces[refrigeratedGoods]      | integer   | 1
| groupOfParkingSpaces[bus]                    | integer   | 1           | restriction[BUS].capacity                 | set only if != 0
...
| parkingUsageScenario[truckParking]           | enum      | 1           |                                           | always `noDynamicParkingManagement`
