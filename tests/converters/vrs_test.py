...
def vrs_vaihingen_config_helper(mocked_config_helper: Mock):
    config = {
        'PARK_API_VRS_CERT': '/dev/null',
        'PARK_API_VRS_KEY': '/dev/null',
        'PARK_API_VRS_VAIHINGEN_STATIC_SUBSCRIPTION_ID': 1234567890,
        'PARK_API_VRS_VAIHINGEN_REALTIME_SUBSCRIPTION_ID': 1234567890,
    }
